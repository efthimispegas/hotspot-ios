...
//hotspots
//--------------------
export const LOAD_USER_HOTSPOTS_SUCCESS = 'LOAD_USER_HOTSPOTS_SUCCESS';
export const LOAD_USER_HOTSPOTS_ERROR = 'LOAD_USER_HOTSPOTS_ERROR';
...
export const EDIT_HOTSPOT_SUCCESS = 'EDIT_HOTSPOT_SUCCESS';
export const EDIT_HOTSPOT_ERROR = 'EDIT_HOTSPOT_ERROR';
export const DELETE_HOTSPOT_SUCCESS = 'DELETE_HOTSPOT_SUCCESS';
export const DELETE_HOTSPOT_ERROR = 'DELETE_HOTSPOT_ERROR';
export const CANCEL_HOTSPOT = 'CANCEL_HOTSPOT';
export const DELETE_EXPIRED_HOTSPOTS_SUCCESS =
  'DELETE_EXPIRED_HOTSPOTS_SUCCESS';
export const DELETE_EXPIRED_HOTSPOTS_ERROR = 'DELETE_EXPIRED_HOTSPOTS_ERROR';
